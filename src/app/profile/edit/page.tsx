...
export default function EditProfile() {
  ...
  return (
    <main className="flex min-h-screen flex-col pb-24 px-6 bg-[#050505] relative overflow-x-hidden">
      
      {/* Header */}
      <header className="w-full flex items-center justify-between pt-[calc(var(--notch-top)+1rem)] pb-4 mb-6 sticky top-0 z-20 bg-[#050505]/80 backdrop-blur-lg">
