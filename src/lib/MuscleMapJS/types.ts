...
export interface MuscleMapOptions {
  ...
  /** Enable pointer interactions (click, hover). Default: `true` */
  interactive?: boolean;
  /** Allow muscles to be selected/deselected on click. Default: `true` */
  selectable?: boolean;
  /** Allow multiple muscles to be selected simultaneously. Default: `true` */
  multiSelect?: boolean;
  locale?: string;
  animated?: boolean;
